...
service cds.xt.ExtensibilityService @(path:'/-/cds/extensibility', impl:'@sap/cds-mtxs/srv/extensibility-service.js') {
  ...
  action activate(ID: Extensions:ID, level: Extensions:status, @open options: {});
...
extend service cds.xt.ExtensibilityService with @private {
  ...
  event activated : {
    tenant : String;
    job_ID : cds.xt.JobsService.Jobs:ID;
    status : cds.xt.JobsService.Jobs:status;
    error  : cds.xt.JobsService.Jobs:error;
  };
}
